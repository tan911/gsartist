  ...
  <div className="space-y-6">
    ...
    <div className="space-y-6">
      <BookingConfirmationMode
        ...
        onChange={(value) =>
          onBookingSettingsUpdate({ confirmationMode: value })
        }
      />
      ...
      <MaxAdvanceBookingSelect
        ...
        onChange={(value) =>
          onBookingSettingsUpdate({ maxAdvanceBooking: value })
        }
      />
      <CustomInstructionsField
        value={bookingSettings.customInstructions}
        onChange={(value) =>
          onBookingSettingsUpdate({ customInstructions: value })
        }
      />
      <CancellationPolicyField
        value={bookingSettings.cancellationPolicy}
        onChange={(value) =>
          onBookingSettingsUpdate({ cancellationPolicy: value })
        }
      />
