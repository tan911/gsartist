...
import { WeeklyWorkingHours } from '@/types/availability-type'
import { Heading3 } from '@/components/typography/Heading3'
import { cn } from '@/lib/utils'
import { Meta } from '@/components/typography/Meta'
import { WorkingHoursSectionSkeleton } from './WorkHoursSectionSkeleton'

interface WorkingHoursSectionProps {
    days: DayOfWeek[]
    dayLabels: Record<DayOfWeek, string>
    workingHours: WeeklyWorkingHours | undefined
    onChange: (
        day: DayOfWeek,
                                    ...
                                    {workingHours[day].isActive ? (
                                        <div className="flex items-center space-x-1 md:space-x-2">
                                            <input
                                                ...
                                                disabled={disabled}
                                            />
                                            <Meta className={cn('font-medium text-gray-900')}>
                                                to
                                            </Meta>
                                            <input
                                                type="time"
...
//                         </div>
//                     ) : (
//                         <span className="text-gray-500 text-xs md:text-sm">Unavailable</span>
//                     )}
//                 </div>
//             ))}
//         </div>
