...
export const PortfolioStats: React.FC<PortfolioStatsProps> = ({ portfolioItems }) => (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4">
        ...
        <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Hair Work</p>
                    <p className="text-xl md:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Makeup Work</p>
                    <p className="text-xl md:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Combo Work</p>
                    <p className="text-xl md:text-2xl font-bold text-gray-900">
