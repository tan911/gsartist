...
export const reviewsLinked = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Perfect for my special day! Sarah made me feel beautiful and confident.",
    date: "2025-06-10",
    replied: true,
    replyText:
      "Thank you Maria! You looked absolutely stunning. Congratulations again!",
  },
];
...
export const allBookingsLinked: Booking[] = [
  ...
  },
  {
    ...
    location: {
      ...
      region: "Manhattan",
      postalCode: "10010",
      coordinates: { lat: 40.742, lng: -73.99 },
      type: "client",
    },
    isTravel: true,
    travelDistance: "6 mi",
  ...
  },
  {
    ...
    location: {
      ...
      region: "Manhattan",
      postalCode: "10022",
      coordinates: { lat: 40.758, lng: -73.97 },
      type: "client",
    },
    isTravel: true,
    travelDistance: "10 mi",
...
export const defaultLocationSettings: LocationSettings = {
  ...
  preferredServiceAreas: ["Manhattan", "Brooklyn", "Queens"],
};
...
// ];
export const radiusOptions: RadiusOption[] = [
  { value: 5, label: "5 mi", description: "Very local (neighborhood)" },
  { value: 10, label: "10 mi", description: "Local area" },
  { value: 25, label: "25 mi", description: "Nearby cities" },
  { value: 50, label: "50 mi", description: "Wider metro area" },
  { value: 100, label: "100 mi", description: "Regional coverage" },
  { value: 200, label: "200 mi", description: "Multi-region area" },
  { value: 500, label: "500 mi", description: "Large state coverage" },
  { value: 1000, label: "1000 mi", description: "Cross-state / national" },
];

export const popularServiceAreas: ServiceArea[] = [
  { id: "1", name: "Manhattan", isActive: true },
  { id: "2", name: "Brooklyn", isActive: true },
  { id: "3", name: "Queens", isActive: true },
  { id: "4", name: "Bronx", isActive: false },
  { id: "5", name: "Staten Island", isActive: false },
  { id: "6", name: "Jersey City", isActive: false },
  { id: "7", name: "Hoboken", isActive: false },
  { id: "8", name: "Long Island City", isActive: false },
];
