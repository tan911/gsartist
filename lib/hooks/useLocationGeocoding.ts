...
export const useLocationGeocoding = ({ onLocationUpdate }: UseLocationGeocodingProps) => {
    ...
    const handleMarkerDragEnd = useCallback(
        async ([lat, lng]: [number, number]) => {
            ...
            if (
                ...
                setNotification({
                    type: 'error',
                    message: 'Invalid coordinates detected. Please try dragging the marker again.',
                })
                return
            }
            ...
            try {
                ...
                setNotification({
                    type: 'error',
                    message: 'Failed to get address details. Coordinates updated successfully.',
                })
            } finally {
