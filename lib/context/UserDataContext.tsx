...
export const useUserProfile = () => {
    const { profile, isLoading, isError, error, refreshData } = useUserDataContext()
    return { profile, isLoading, isError, error, refreshData }
}

export const useUserBookings = () => {
    const { bookings, isLoading, isError, error, refreshData } = useUserDataContext()
    return { bookings, isLoading, isError, error, refreshData }
}

export const useUserServices = () => {
    const { services, isLoading, isError, error, refreshData } = useUserDataContext()
    return { services, isLoading, isError, error, refreshData }
}

export const useUserStats = () => {
    const { stats, isLoading, isError, error, refreshData } = useUserDataContext()
    return { stats, isLoading, isError, error, refreshData }
}

export const useUserConversations = () => {
    const { conversations, isLoading, isError, error, refreshData } = useUserDataContext()
    return { conversations, isLoading, isError, error, refreshData }
}

export const useUserPortfolio = () => {
    const { portfolio, isLoading, isError, error, refreshData } = useUserDataContext()
